<?php
	function headhtml(){
	  ...
	  <script type="text/javascript">
			...
			<div id="main_container">
			  ...
			  <div id="header">
				<div id="download"> <a href="#"><img src="images/auction.png" alt="" border="0" width="300" height="200" /></a> </div>
	...
	function foothtml(){
		echo ' <div class="footer">
				<div class="left_footer"> <img src="images/auction.png" alt="" width="100" height="49"/> </div>
				<div class="center_footer"> Online Auction.<br/>
				 All Rights Reserved 2020<br />
				  <a href="http://csscreme.com"></a><br />
				   </div>
