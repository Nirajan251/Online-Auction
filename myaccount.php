 ...
 <script type='text/javascript'>
	jQuery(document).ready( function() {
		...
		jQuery('.two').click( function() {
            ...
            <div class="thumbs"><center><div class="three">View Personal Info</div></center></div>
          </div>
          <div class="details_big_box">
            ...
            <div class="specifications">
			 ...
			 <div id="regstep1">
				...
				mysql_query("UPDATE member SET lastname='$last_save', firstname='$fname_save', gender='$gender_save', address='$address_save', birthdate='$bday_save' WHERE memberid='$userid'") or die (mysqli_error());
           ...
           <strong>Contact:</strong> 
			...
			//mysql_query("INSERT INTO member (memberimg) VALUES '$name' WHERE memberid='$userid'") or die(mysqli_error());
			header("location: myaccount.php");
			}
			?>
